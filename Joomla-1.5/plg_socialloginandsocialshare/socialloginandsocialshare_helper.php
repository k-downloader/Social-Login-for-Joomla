 ...
 */
   public static function enterEmailPopup($title, $msg, $msgtype) {
	 ...
	 $output .='<div id="popupouter"><p id ="outerp"> '.$title.'</p><div id="popupinner"><div id="textmatter" style ="'.$style.'">';
     if ($msg) {
	 ...
	 $output .= '<input type="submit" name="sociallogin_emailclick" value="'.JText::_('LOGIN').'" class="inputbutton"/>';
	 $output .= '<input type="submit" value="'.JText::_('CANCEL').'" name = "cancel" class="inputbutton"/>';
