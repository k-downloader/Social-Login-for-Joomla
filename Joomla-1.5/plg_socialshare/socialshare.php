    ...
    */
	...
	public function onBeforeDisplayContent(&$article, &$params, $limitstart) {
		...
		if(!($this->share_widget_position)) {
            ...
            foreach ($this->share_articles as $key=>$value) {
			  if ($article->id == $value) {
			    ...
			    $beforediv = "<DIV style='padding-bottom:10px;padding-top:10px;text-align:".$this->share_alignment."'>".$this->showShare()."</DIV>";
			  }
			}
		  }
		}
		if(!($this->counter_widget_position)) {
			...
			$beforediv.= "<DIV style='padding-bottom:10px;padding-top:10px;text-align:".$this->counter_alignment."' >".$this->showCounter()."</DIV>";
			}
		  }
		}
	  }
	...
	public function onAfterDisplayContent(&$article, &$params, $limitstart) {
		...
		if(($this->share_widget_position)) {
			...
			$afterdiv = "<DIV style='padding-bottom:10px;padding-top:10px;text-align:".$this->share_alignment."'>".$this->showShare()." </DIV>";
			  }
		    }
		  }
		}
		if(($this->counter_widget_position)) {
			...
			$afterdiv .= "<DIV style='padding-bottom:10px;padding-top:10px;text-align:".$this->counter_alignment."'>".$this->showCounter()." </DIV>";
			}
		  }
		}
      }
