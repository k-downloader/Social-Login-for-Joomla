  ...
  <tr class="row_white">
    <td>
      <div class="row row_button">
        <div class="button2-left">
          <div class="blank">
            <a href="javascript:void(0);" onclick="MakeRequest();"><b style="color:#C91F00 !important;"><?php echo JText::_('COM_SOCIALLOGIN_SETTING_VERIFYAPI'); ?></b>
			</a>
		  </div>
        </div>
      </div>
...
<tr>
	...
	<input size="60" type="text" name="settings[emailtitle]" id="Popup_Email_Title" value="<?php echo $emailtitle; ?>" />
      <br />
	  </td>
  </tr>
  <tr class="row_white">
  <?php
	  ...
	  ?>
  <td>
	  <span class="subhead"><?php echo JText::_('COM_SOCIALLOGIN_SETTING_EMAIL_TITLE_MESSAGE'); ?></span><br /><br /><input size="60" type="text" name="settings[emailrequiredmessage]" id="Popup_Email_Message" value="<?php echo $emailrequiredmessage; ?>" />
      <br />
	  </td>
  </tr>
  <tr>
  <?php  
	  ...
	  ?>
  <td>
	  <span class="subhead"><?php echo JText::_('COM_SOCIALLOGIN_SETTING_ERROR_EMAIL_TITLE_MESSAGE'); ?></span><br /><br /><input size="60" type="text" name="settings[emailinvalidmessage]" id="Popup_Error_Email_Message" value="<?php echo $emailinvalidmessage; ?>" />
	</td>
  </tr>
</table>
<table class="form-table sociallogin_table">
