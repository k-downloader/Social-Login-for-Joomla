...
?>
  ...
  <tr >
    <td colspan="2" ><span class="sociallogin_subhead"><?php echo JText::_('COM_ENABLE_DISABLE_SOCIALLOGIN'); ?></span>
	  <br/><br />
      <input style="margin:0" name="settings[enableSocialLogin]" type="radio" value="1" <?php echo !isset($this->settings['enableSocialLogin']) || $this->settings['enableSocialLogin'] == '1' ? 'checked="checked"' : ''; ?> /> <?php echo JText::_('COM_SOCIALLOGIN_YES'); ?> 
	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <input style="margin:0" name="settings[enableSocialLogin]" type="radio" value="0" <?php echo isset($this->settings['enableSocialLogin']) && $this->settings['enableSocialLogin'] == '0' ? 'checked="checked"' : ''; ?> /> <?php echo JText::_('COM_SOCIALLOGIN_NO'); ?> 
	</td>
  </tr>
</table>
<table class="form-table sociallogin_table">
	...
	<tr class="sociallogin_row_white">
	   ...
	   <span class="sociallogin_subhead"><?php echo JText::_('COM_SOCIALLOGIN_SOCIAL_SHARE_THEME'); ?></span><br /><br />
	    <?php $hori32 = "";
		 ...
		 <span class="sociallogin_subhead"><?php echo JText::_('COM_SOCIALLOGIN_SOCIAL_SHARE_HORIZONTAL'); ?></span><br/>
       <?php $enablehshare = "";
             $disablehshare = "";
	   ...
	   ?>
	   <span class="sociallogin_subhead"><?php echo JText::_('COM_SOCIALSHARE_TITLE'); ?></span><br/>
	   <input name="settings[beforesharetitle]" type="text" id="beforesharetitle"  value="<?php echo $beforesharetitle; ?>"  /></div><br/>
	   <div style="overflow:auto; background:#EBEBEB; padding:10px;"><span class="sociallogin_subhead"><?php echo JText::_('COM_SOCIALLOGIN_SOCIAL_SHARE_HORIZONTAL_THEMES'); ?></span><br /><br />
	  ...
	  <span class="sociallogin_subhead"><?php echo JText::_('COM_SOCIALLOGIN_SOCIAL_SHARE_POSITION'); ?></span><br/><br/>
       ...
       <span class="sociallogin_subhead"><?php echo JText::_('COM_SOCIALLOGIN_SOCIAL_SHARE_REARRANGE'); ?></span><br />
...
<?php }?>
		 ...
		 <span class="sociallogin_subhead"><?php echo JText::_('COM_SOCIALLOGIN_SOCIAL_SHARE_ENABLE_VERTICAL'); ?></span><br/>
       <?php $enablevshare = "";
             $disablevshare = "";
	   ...
	   <input name="settings[sharevertical]" type="radio" <?php echo $disablevshare;?> value="0"  /> <?php echo JText::_('COM_SOCIALLOGIN_NO'); ?> </div><br /><br />
      ...
      <input name="settings[chooseverticalshare]" id = "cvertibox16" onclick="createvercounprovider();" type="radio" <?php echo $cvertibox16;?> value="3" /> <img src = '<?php echo "components/com_socialloginandsocialshare/assets/img/hybrid-verticle-vertical.png"?>' style="vertical-align:top;" /><br/><br/>
         ...
         <div style="overflow:auto; background:#EBEBEB; padding:10px;">
         <p style="margin:0 0 6px 0; padding:0px;"><span class="sociallogin_subhead"><?php echo JText::_('COM_SOCIALLOGIN_SOCIAL_SHARE_THEME_POSITION'); ?></span></p>
         <?php $topleft = "";
	        $topright = "";
			$bottomleft = "";
			$bottomright = "";
        ...
        <div style="overflow:auto; background:#FFFFFF; padding:10px;">
		<span class="sociallogin_subhead"><?php echo JTEXT::_('COM_SOCIALLOGIN_SOCIAL_SHARE_TOP_OFFSET'); ?></span><a href="javascript:void(0);" style="text-decoration:none;" title="<?php echo JTEXT::_('COM_TOP_OFFSET_HELP'); ?>" >(?)</a><br/><br/><input type="text" id="topoffset" name="settings[verticalsharetopoffset]" value="<?php echo $verticalsharetopoffset; ?>" >
         </div>
